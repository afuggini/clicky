 ...
 * Clicky Proxy Worker
 *
 * Proxies requests to OpenRouter (chat), OpenAI (TTS + transcription)
 ...
 *   POST /transcribe  → OpenAI Whisper transcription API
 */
...
async function handleTranscribe(request: Request, env: Env): Promise<Response> {
  // Forward the multipart form data as-is to OpenAI, adding the auth header
